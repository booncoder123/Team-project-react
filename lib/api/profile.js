...
class Profile {
  ...
  static DELETE_PROJECTS = "deleteProjects";
  ...
  static delete(options){
    switch(options.type){
      ...
      case Profile.DELETE_PROJECTS:
        return Profile.deleteProjects(options);
      default:
        return
    }
  }
  ...
  static deleteProjects(options){
    const config = {
      method: HTTP_METHODS.delete,
      url: `/v1/post/delete-project`,
      body: options.body,
      token: options.token,
    };
